...
from src.utils.func import load_config, get_pictures, apply_hough_transformation, group_lines, plot_results, compose_court_data, validate_data_and_pictures
from src.utils.lines import Line
from src.utils.corners import CourtFinder


def run(result_dir: Path = Path('results/run')):
